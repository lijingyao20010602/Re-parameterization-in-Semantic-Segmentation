...
class DBB3(nn.Module):
    ...
    def get_equivalent_kernel_bias(self):
        ...
        if not hasattr(self, 'id_tensor'):
            ...
            self.id_tensor = torch.from_numpy(kernel_value).to(self.dbb_identity.weight.device)
        k_id, b_id = transI_fusebn(self.id_tensor, self.dbb_identity)

        return transII_addbranch((k_origin, k_1x1, k_1x1_kxk_merged, k_id), (b_origin, b_1x1, b_1x1_kxk_merged, b_id))
